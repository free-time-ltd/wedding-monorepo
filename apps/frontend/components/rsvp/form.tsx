...
const fieldConfig = {
  ...
  transportation: {
    label: "Ще Ви е необходим ли транспорт или паркинг?",
    options: [
      { value: "parking", label: "Ще ми е необходимо място за паркиране" },
      {
        value: "shuttle",
        label: "Бих желал/а да ползвам организиран транспорт до мястото",
      },
      {
        value: "no",
        label: "Няма да ми е необходим транспорт (ще използвам такси)",
      },
    ],
  },
  accommodation: {
